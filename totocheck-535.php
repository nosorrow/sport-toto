    ...
    <div class="my-2 my-lg-0">
      <ul class="navbar-nav mr-auto">
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item">
            <a class="nav-link" href="#" onclick="generator(649, event)">6 / 49 <span
  ...
  <div class="row mt-3 mb-1">
    <div class="col-md-12 col-xs-12 text-center">
      <h2><span style="padding: 12px 10px; display: inline-block">Проверка на комбинация в играта </span><span
                class="igra bg-primary"> 5 / 35</span></h2>
    </div>
  </div>
  ...
  <form action="" method="post" id="checkform">
    <div class="form-row form-row-styled">
      ...
      <div class="form-group col-md-2 col-6">
        <input type="number" name="one" id="one" min="1" max="35" class="form-control" placeholder="20">
      </div>
      <div class="form-group col-md-2 col-6">
        <input type="number" name="two" id="two" min="1" max="35" class="form-control" placeholder="15">
      </div>
      <div class="form-group col-md-2 col-6">
        <input type="number" name="three" id="three" min="1" max="35" class="form-control" placeholder="1">
      </div>
      <div class="form-group col-md-2 col-6">
        <input type="number" name="four" id="four" min="1" max="35" class="form-control" placeholder="3">
      </div>
      <div class="form-group col-md-2 col-6">
        <input type="number" name="five" id="five" min="1" max="35" class="form-control" placeholder="35">
      </div>
      <div class="col-md-1"></div>
    </div>
